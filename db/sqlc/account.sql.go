...
UPDATE accounts
  set balance = balance + $1 /*set generated parameters to amount*/
WHERE id = $2 /*set generated parameters to id*/
...
VALUES
  ($1, $2, $3) RETURNING id, owner, balance, currency, created_at, country_code
`
